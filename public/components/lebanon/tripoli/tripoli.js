var app = angular.module("myapp.tripoli", ["ngRout", "myapp"]);
app.config(function ($routProvider) {
    $routProvider.when("/tripoli", {
        templateUrl: "./tripoli.html",
        controller: "tripoliController"
    })
})
app.controller("tripoliController", function ($scope, lebanonService) {
    //get data
